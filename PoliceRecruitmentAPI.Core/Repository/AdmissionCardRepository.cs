...
{
	public class AdmissionCardRepository
	{
		private readonly DatabaseContext _dbContext;

		public AdmissionCardRepository(DatabaseContext dbContext)
		{
		...
		public async Task<IActionResult> Get(CandidateDto model)
		{
			using (var connection = _dbContext.CreateConnection())
			{
				...
				try
				{
					...
					var queryResult = await connection.QueryMultipleAsync("Proc_AdmissionCard", parameter, commandType: CommandType.StoredProcedure);
